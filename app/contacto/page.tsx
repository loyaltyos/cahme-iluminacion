    ...
    <section className="container-page grid gap-10 py-16 lg:grid-cols-[0.9fr_1.1fr]">
      <div>
        ...
        <div className="mt-8 grid gap-4 text-camhe-graphite">
          <p className="flex items-center gap-3"><Phone className="text-camhe-red" /> +52 999 000 0000</p>
          <p className="flex items-center gap-3"><Mail className="text-camhe-red" /> ventas@camheiluminacion.com</p>
          <p className="flex items-center gap-3"><MapPin className="text-camhe-red" /> México</p>
        </div>
      </div>
